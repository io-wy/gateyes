...
import (
	...
	gatewaytrace "github.com/gateyes/gateway/internal/platform/trace"
)
...
func TestOtelTrace_StartsSpan(t *testing.T) {
	...
	engine.GET("/test", func(c *gin.Context) {
		span := gatewaytrace.OTelSpanFromContext(c.Request.Context())
		if span == nil {
...
func TestOTelSpanFromContext_Missing(t *testing.T) {
	ctx := httptest.NewRequest(http.MethodGet, "/", nil).Context()
	span := gatewaytrace.OTelSpanFromContext(ctx)
